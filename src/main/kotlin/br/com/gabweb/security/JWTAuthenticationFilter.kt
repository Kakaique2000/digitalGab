package br.com.gabweb.security
...
import br.com.gabweb.add
import br.com.gabweb.config.SecurityProperties
import br.com.gabweb.domain.Usuario
import br.com.gabweb.domain.dto.TokenDTO
import br.com.gabweb.writeValueAsString
...
class JWTAuthenticationFilter(
  ...
  override fun attemptAuthentication(
    ...
    return try {
      ...
      val creds = mapper
        .readValue<Usuario>(req.inputStream)
...
//    res.addCookie(Cookie(securityProperties.headerString, token))
    res.outputStream.write(mapper.writeValueAsBytes(mapOf(Pair("data",  TokenDTO(token)))))
  }
}
