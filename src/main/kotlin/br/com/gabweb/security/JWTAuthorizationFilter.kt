...
class JWTAuthorizationFilter(
  ...
  override fun doFilterInternal(
    ...
    val cookie = req.cookies?.let {
      it.associate { cookie -> Pair(cookie.name, cookie) }[securityProperties.headerString]
    }
      if (cookie != null) {
        getAuthentication("${securityProperties.tokenPrefix}${cookie.value}")?.also {
